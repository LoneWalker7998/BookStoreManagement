...
public class admin {
	...
	void admin_function(String uname)throws Exception{
		c.connection();
		...
		while(true) {
			...
			System.out.println("3. Shopkeeper Section");
			...
			switch(choice) {
				...
				case 2: int c2 = 0;
						while(true) {
							...
							switch(option2) {
								...
								case 3: System.out.print("Entre username to delete user: ");
							 			String user = in.nextLine();
							 			PreparedStatement pst2 = c.c.prepareStatement("DELETE FROM users where username = '"+user+"'");
							 			pst2.executeUpdate();
							 			System.out.println("User is removed system.");
							 			break;
				...
				case 3: int c3 = 0;
						while(true) {
							System.out.println("\n***************** Options *****************");
							System.out.println("|=========================================|");
							System.out.println("1. Add Shopkeeper");
							System.out.println("2. View all Shopkeepers");
							System.out.println("3. Remove a Shopkeeper");
							System.out.println("4. Go back");
							System.out.println("|=========================================|\n");
							...
							switch(option3) {
								case 1:	System.out.println("***************** Enter Shopkeeper Details *****************\n");
										...
										try {
											...
											sql = "INSERT INTO shopkeeper VALUES('"+name+"', '"+passd+"', '"+fname+"', '"+lname+"', '"+add+"', '"+mob+"', '"+email+"')";
											st.executeUpdate(sql);
								...
								case 2: System.out.println("============================================================== All Shopkeepers  ============================================================");
								...
								case 3: System.out.print("Entre username to delete Shopkeeper: ");
							 			String user = in.nextLine();
							 			PreparedStatement pst2 = c.c.prepareStatement("DELETE FROM shopkeeper where username = '"+user+"'");
							 			pst2.executeUpdate();
							 			System.out.println("User is removed system.");
							 			break;
				...
				case 4: System.out.print("Enter your current password: ");
						...
						if(old_p.equals(pass)) {
							...
							if(old_p.equals(new_p)) {
								...
								sql = "UPDATE admin SET password='"+new_p+"' WHERE username='"+uname+"'";
								st.executeUpdate(sql);
